  ...
  return (
    <ProgramHub
      ...
      externalSite={{
        ...
        label: "Visit Vivinate Farms",
        description: "Program details, family applications, farm updates, and the full Vivinate Farms mission live at the dedicated website",
      }}
      modules={[
      ...
      ctas={[
        { label: "Visit vivinatefarms.org", href: "https://www.vivinatefarms.org", primary: true, external: true },
        { label: "Run the simulator", href: "/simulator" },
